  ...
  return (
    <>
      ...
      <Presence present={open}>
        <div
          className={cn(
            'fixed top-2 right-2 bottom-2 z-30 overflow-hidden bg-fd-card text-fd-card-foreground border rounded-2xl shadow-xl [--ai-chat-width:400px] 2xl:[--ai-chat-width:460px]',
            open
              ? 'animate-fd-dialog-in'
              : 'animate-fd-dialog-out',
          )}
          style={{ width: 'var(--ai-chat-width)' }}
        >
